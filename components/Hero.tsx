      ...
      <div className="grid lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-5 relative">
          <div className="relative flex justify-center items-end group perspective-1000">
            ...
            <div className="hidden lg:block absolute bottom-16 -left-8 sm:bottom-14 sm:-left-16 glass-card p-5 rounded-3xl border border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.15)] animate-bounce-slow transform hover:scale-110 transition-transform duration-500 cursor-default z-20">
